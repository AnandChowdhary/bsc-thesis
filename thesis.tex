...
\begin{table}[!htb]
	\begin{minipage}{1\linewidth}
		...
		\begin{tabular}{|*{13}{p{0.5cm}|}}
			\hline
			& \textbf{Q1} & \textbf{Q2} & \textbf{Q3} & \textbf{Q4} & \textbf{Q5} & \textbf{Q6} & \textbf{Q7} & \textbf{Q8} & \textbf{Q9} & \textbf{Q10} & \textbf{Q11} & \textbf{Q12} \\
			\hline
			...
			$\bar{x}$ & \textbf{4.3} & \textbf{4.6} & \textbf{4.4} & \textbf{4.3} & \textbf{4.7} & \textbf{4.5} & \textbf{4.1} & \textbf{4.4} & \textbf{4.3} & \textbf{4.3} & \textbf{4.1} & \textbf{3.8} \\
			$\tilde{x}$ & 4 & 5 & 4 & 4 & 5 & 5 & 4 & 5 & 5 & 5 & 4 & 4 \\
			$Mo$ & 5 & 5 & 4 & 5 & 5 & 5 & 5 & 5 & 5 & 5 & 4 & 4 \\
			\hline
		\end{tabular}
	\end{minipage}%
\end{table}
