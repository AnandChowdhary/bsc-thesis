...
For this research, four kinds of users are explored in different contexts. The Random User Generator service is used to programmatically generate names --- Tanya Gonzalez, Julia Morris, Joy Fields, and Lee Henderson.
...
\begin{table}[!htb]
	\begin{minipage}{1\linewidth}
		...
		\begin{tabular}{lll}
			...
			Julia         & Medium          & Clents' time slots.          \\
...
\begin{figure}
  ...
  \caption{Prototype user interface webpages}
\end{figure}
